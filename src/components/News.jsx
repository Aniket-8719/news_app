...
const News = (props) => {
  ...
  const updateNews = async () => {
    ...
    const url = `https://newsapi.org/v2/top-headlines?country=us&category=${props.category}&apiKey=f3032d89d372488496f51c31c641cf0d&page=${page}&pageSize=${props.pageSize}`;
    setLoading(true);
    try {
  ...
  const fetchMoreData = async () => {
    ...
    const url = `https://newsapi.org/v2/top-headlines?country=us&category=${props.category}&apiKey=f3032d89d372488496f51c31c641cf0d&page=${page + 1}&pageSize=${props.pageSize}`;
    try {
      let data = await fetch(url);
      let parsedData = await data.json();
